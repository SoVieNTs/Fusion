                ...
                <h1>About</h1>
                    <p>Fusion includes so many great features such as reaction roles, fun commands and most importantly Moderation. Fusion is extremly simple to use, setup and configure with tons of avaliable features to customise.</p>
                      <h3>Here are the commands you can use with Fusion.</h3>
                        <p class="commands">🛠️ Moderation/Admin: <br><code>warn</code>, <code>ban</code>, <code>kick</code>, <code>clear</code>, <code>rr-add</code></p>
                        <p class="commands">🕹 Recreational: <br><code>8ball</code>, <code>dice</code>, <code>meme</code>, <code>coinflip</code>, <code>roast</code></p>
                        <p class="commands">👻 Roleplay: <br><code>nuke</code>, <code>slap</code>, <code>hug</code>, <code>punch</code>, <code>laugh</code></p>
                  `;
            break;
        default:

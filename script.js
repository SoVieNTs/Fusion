...
function changeView(type, title) {
    ...
    switch (type) {
        case "updates":
            content.innerHTML = `
                    <h1>Updates</h1>
                        <p>This is a feature that is currently in development, check back later to see how much progress is being made!</p>
                      `;
            break;
        case "bug":
            content.innerHTML = `
        ...
        case "about":
            content.innerHTML = `
                <h1>About</h1>
                    <p>Fusion includes so many great features such as reaction roles, starboard, fun commands that get your whole server giggling and last but not least moderation. Super simple and efficiently ready for use however you'd like too, made to improve your Discord Server!</p>
                      <h3>Here are the commands you can use with Fusion.</h3>
                        ...
                        <p class="commands">🕹 Fun: <br><code>8ball</code>, <code>dice</code>, <code>meme</code>, <code>coinflip</code>, <code>roast</code>. <code>pun</code>, <code>dadjoke</code>, <code>rps</code>, <code>cuteness</code>, <code>butt</code>, <code>yomama</code></p>
